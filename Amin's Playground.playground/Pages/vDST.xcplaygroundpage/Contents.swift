...
var dst_frequency_real = [PixelType](repeating: 0,
                                 count: n)
var dst_frequency_imaginary = [PixelType](repeating: 0,
                                      count: n)
var dstFreqImageSplitComplex: SplitComplexType!

var multi_product_real = [PixelType](repeating: 0,
                                 count: n)
var multi_product_imaginary = [PixelType](repeating: 0,
                                      count: n)
var multiProductSplitCompltex: SplitComplexType!

var ifft_product_real = [PixelType](repeating: 0,
                                count: n)
var ifft_product_imaginary = [PixelType](repeating: 0,
                                     count: n)
...
dst_frequency_imaginary.withUnsafeMutableBufferPointer { dstFreqImagPtr in
    ...
    fftSetUp.transform(input: dstImageSplitComplex,
...
vDSP.multiply(srcFreqImageSplitComplex,
...
//}
//}
fftSetUp.transform(input: multiProductSplitCompltex,
