...
// New style transform
var transformedImageReal = [Float](
    repeating: 0,
    count: n
)
var transformedImageImaginary = [Float](
    repeating: 0,
    count: n
)
...
var transformedImageRealRev = [Float](
    repeating: 0,
    count: n
)
var transformedImageImaginaryRev = [Float](
    repeating: 0,
    count: n
)
